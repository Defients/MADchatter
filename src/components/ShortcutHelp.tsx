...
const SHORTCUTS = [
  ...
  { keys: ['Q'], label: 'AutoForge decision history — older page', category: 'AutoForge' },
  { keys: ['W'], label: 'Send the viewed AutoForge decision', category: 'AutoForge' },
  { keys: ['E'], label: 'AutoForge decision history — newer page', category: 'AutoForge' },
